...
export default class AdaptiveCollectionControl extends React.Component {
  constructor(props) {
    super(props);
  ...
  onAdd() {
    if (this.props.value.indexOf('') !== -1) return;
    ...
    return (
      ...
      >
        {this.props.value.map((o, i) => (
          ...
          >
            <SortableDragger />
            <div style={{ flex: '1 1 100px', margin: '-2px 5px' }}>
              <OnPasteSelect
...
AdaptiveCollectionControl.propTypes = propTypes;
AdaptiveCollectionControl.defaultProps = defaultProps;
